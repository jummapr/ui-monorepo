...
})({"7fNDc":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b4082cde600d84c9";
"use strict";
...
},{}],"drDZm":[function(require,module,exports) {
"use strict";
const myUiLibrary = require("8fa4033dc016cc6b");

},{"8fa4033dc016cc6b":"e1fkW"}],"e1fkW":[function(require,module,exports) {
...
const myUiLibrary = ()=>{
    ...
    const createH1 = (state)=>(0, _snabbdom.h)("h1", {}, state.count);
    function createTemplate(state, props) {
        console.log(state);
        return (0, _snabbdom.h)("div#app", [
...
},{"./htmldomapi.js":"ec4Mk","./init.js":"d6X9p","./thunk.js":"hwP52","./vnode.js":"fNqAR","./helpers/attachto.js":"fImBB","./is.js":"kHAzx","./tovnode.js":"4KcTS","./h.js":"bCpOB","./hooks.js":"4VlVB","./modules/attributes.js":"ir8ta","./modules/class.js":"1UVqj","./modules/dataset.js":"hwohf","./modules/eventlisteners.js":"hZwdS","./modules/props.js":"lumw8","./modules/style.js":"6POOZ","./jsx.js":"f2XQl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ec4Mk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hwP52":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./h.js":"bCpOB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bCpOB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./vnode.js":"fNqAR","./is.js":"kHAzx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fImBB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4KcTS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function toVNode(node, domApi) {
    ...
    if (api.isElement(node)) {
        ...
        for(i = 0, n = elmAttrs.length; i < n; i++){
            ...
            if (name.startsWith("data-")) dataset[name.slice(5)] = elmAttrs[i].nodeValue || "";
        ...
        if (sel.startsWith("svg") && (sel.length === 3 || sel[3] === "." || sel[3] === "#")) (0, _hJs.addNS)(data, children, sel);
        return (0, _vnodeJs.vnode)(sel, data, children, undefined, node);
    } else if (api.isText(node)) {
        text = api.getTextContent(node);
        return (0, _vnodeJs.vnode)(undefined, undefined, undefined, text, node);
    } else if (api.isComment(node)) {
        text = api.getTextContent(node);
        return (0, _vnodeJs.vnode)("!", {}, [], text, node);
    } else return (0, _vnodeJs.vnode)("", {}, [], undefined, node);
}

},{"./h.js":"bCpOB","./vnode.js":"fNqAR","./htmldomapi.js":"ec4Mk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4VlVB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ir8ta":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hwohf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function updateDataset(oldVnode, vnode) {
    ...
    dataset = dataset || {};
    const d = elm.dataset;
    for(key in oldDataset)if (!(key in dataset)) {
        if (d) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f2XQl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Fragment", ()=>Fragment);
/**
...
function Fragment(data, ...children) {
    ...
    return (0, _vnodeJs.vnode)(undefined, undefined, undefined, flatChildren[0].text, undefined);
    else return (0, _vnodeJs.vnode)(undefined, data !== null && data !== void 0 ? data : {}, flatChildren, undefined, undefined);
}
function flattenAndFilter(children, flattened) {
    ...
    if (child !== undefined && child !== null && child !== false && child !== "") {
        ...
        else if (typeof child === "string" || typeof child === "number" || typeof child === "boolean") flattened.push((0, _vnodeJs.vnode)(undefined, undefined, undefined, String(child), undefined));
...
function jsx(tag, data, ...children) {
    ...
    return tag(data, flatChildren);
        ...
        if (flatChildren.length === 1 && !flatChildren[0].sel && flatChildren[0].text) // only child is a simple text node, pass as text for a simpler vtree
        return (0, _hJs.h)(tag, data, flatChildren[0].text);
        else return (0, _hJs.h)(tag, data, flatChildren);
    }
}

},{"./vnode.js":"fNqAR","./h.js":"bCpOB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7fNDc","drDZm"], "drDZm", "parcelRequire6577")

//# sourceMappingURL=index.600d84c9.js.map
